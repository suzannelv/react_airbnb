...
import IconTriangleBottom from "@/assets/svg/icon-triangle-down";
import Indicator from "../indicator";
import classNames from "classnames";
import IconTriangleTop from "@/assets/svg/icon-trangle-top";
                ...
                <div className="info">
                    <div className="desc">
                        <div className="count">
                            ...
                            <span>room appart 图片{currentIndex + 1}</span>
                        </div>
                        <div
                            className="toggle"
